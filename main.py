...
# Faire un rectangle blanc et coller une image par dessus
...
Liste_images = [tk.PhotoImage(file="Images/Murloc_1.png") , tk.PhotoImage(file="Images/Murloc_2.png"), tk.PhotoImage(file="Images/Paladin_1.png"),tk.PhotoImage(file="Images/Bete_1.png") ]
...
border_id_joueur_waiting_liste = [border_id_joueur_waiting_0, border_id_joueur_waiting_1, border_id_joueur_waiting_2, border_id_joueur_waiting_3, border_id_joueur_waiting_4, border_id_joueur_waiting_5]
...
def clic_sur_image_taverne(event, colors_index):
...
canvas.tag_bind(image_taverne[0], "<Button-1>", lambda event: clic_sur_image_taverne(event, 0))
canvas.tag_bind(image_taverne[1], "<Button-1>", lambda event: clic_sur_image_taverne(event, 1))
canvas.tag_bind(image_taverne[2], "<Button-1>", lambda event: clic_sur_image_taverne(event, 2))
...
def clic_sur_image_board(event, x,y, indice_board):
    ...
    for i in range(3):
        if colors_taverne[i] == 1:
            ...
            border_id_taverne_liste[i] = canvas.create_rectangle(235 +210*i, 100, 235+210*i + 167, 100 + 260, outline='blue', width=5)
...
def Bataille(p1, p2):
    ...
    while (p1.battlers_on_field != ["void","void","void","void"] or p2.battlers_on_field != ["void","void","void","void"]):
        next_attacker = 1       #
        if (next_attacker == 1):
