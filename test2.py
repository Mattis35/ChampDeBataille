...
def mise_a_jour_taverne():
    for i in range(3):
        if emplacement_taverne_libre[i] != 0:
            label = tk.Label(fenetre, text=emplacement_taverne_libre[i].pv, font=("Calibri", 12), fg="red", bg="wheat")
            label.place(x=365 +i*210, y=266)
    for i in range(6):
        if emplacement_board_libre[i] != 0:
            label = tk.Label(fenetre, text=emplacement_board_libre[i].pv, font=("Calibri", 12), fg="red", bg="wheat")
            label.place(x=155 +i*210, y=886)
